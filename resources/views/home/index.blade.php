...
@section('konten')
    ...
    {{-- button --}}
    <div class="px-[80px] mt-5">

        <a href="{{ url('home/create') }}" class="px-6 py-2 bg-[#666666] text-white text-center ">Tambah</a>
        <a href="{{ url('all-product') }}" class="px-6 py-2 bg-[#666666] text-white text-center ">Edit Product</a>
    </div>
    {{-- /button --}}
